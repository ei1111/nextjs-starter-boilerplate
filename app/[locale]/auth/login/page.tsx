    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 flex flex-col items-center">
          ...
          <h1 className="mt-4 text-xl font-bold text-foreground">{t("login_title")}</h1>
          <p className="mt-1 text-sm text-muted-foreground">{t("login_desc")}</p>
        </div>

        {/* Demo accounts notice */}
        <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50 p-3">
          <p className="text-xs font-medium text-blue-800">{t("test_accounts")}</p>
          <p className="mt-1 text-xs text-blue-700">{t("test_user")}</p>
          <p className="text-xs text-blue-700">{t("test_admin")}</p>
        </div>
        ...
        <div className="my-6 flex items-center gap-3">
          ...
          <span className="text-xs text-muted-foreground">{t("or" as never) ?? "또는"}</span>
          <Separator className="flex-1" />
        </div>
        ...
        <p className="mt-6 text-center text-sm text-muted-foreground">
          {t("no_account")}{" "}
          <Link href="/auth/join" className="font-medium text-primary hover:underline">
            {t("signup")}
          </Link>
        </p>
      </div>
